package com.example;
import com.example.utils.AbsConcurrentServer;
...
public class StartObjectServer {
    ...
    public static void main(String[] args){
        ...
        try {
            serverProps.load(StartObjectServer.class.getResourceAsStream("/transportserver.properties"));
        ...
        AbstractServer server = new TransportObjectConcurrentServer(transportServerPort, service);
        try {
            server.start();
